...
class MySTT:
    def __init__(self, model_name, scorer, VAD):
    ...
    def init_STT(self):
        ...
        if os.path.isdir(self.model_name):
            ...
            self.model_name = os.path.join(model_dir, 'output_graph.pb')
            self.scorer = os.path.join(model_dir, self.scorer)
        
        print('Initializing STT model...')
        self.model = stt.Model(self.model_name)
        self.model.enableExternalScorer(self.scorer)
        # Start audio with VAD
        self.vad_audio = VADAudio(aggressiveness=self.VAD,
